...
public class SearchAlgoTest {
	...
	public void testLinearSearch() {
		assertEquals(this.expected, Search.linearSearch(this.array,0,this.array.length - 1, this.value));
	}
	...
	public void testBinarySearch() {
		assertEquals(this.expected, Search.binarySearch(this.array, 0, this.array.length - 1, this.value));
	}
}
